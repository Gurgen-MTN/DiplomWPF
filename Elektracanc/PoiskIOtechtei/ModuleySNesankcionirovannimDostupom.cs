...
{
    public partial class ModuleySNesankcionirovannimDostupom : Form
    {
        public ModuleySNesankcionirovannimDostupom()
        {
            InitializeComponent();
        }
        ...
        private async void Poisk()
        {
            ...
            column5.HeaderText = "AccessQuantity";
            column5.ReadOnly = true;
            column5.Name = "AccessQuantity";
            column5.CellTemplate = new DataGridViewTextBoxCell();
            dataGridView1.Columns.Add(column5);
            var column6 = new DataGridViewColumn();
            column6.HeaderText = "BadAccessQuantity";
            column6.ReadOnly = true;
            column6.Name = "BadAccessQuantity";
        ...
        private void ModuleySNesankcionirovannimDostupom_Load(object sender, EventArgs e)
        {
        ...
        private void ModuleySNesankcionirovannimDostupom_FormClosing(object sender, FormClosingEventArgs e)
        {
